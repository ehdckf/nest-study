...
import { HandlerMetadata,HandleResponseFn, HandlerMetadataStorage } from '@nestjs/core/helpers/handler-metadata-storage';
...
export class JsonRpcContextCreator {
    ...
    public create<TContext extends string = ContextType>(
        ...
        return async <TRequest, TResponse>(
            ...
            return await fnHandleResponse.call(this,result,res);
        };
    }
    ...
    public createHandleResponseFn() {
        return async <TResult, TResponse>(result: TResult, res: TResponse) => {
            const response = await this.transformToResult(result);
