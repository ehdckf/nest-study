...
export function createClassDecorator<T extends Array<any> = any>(metakey:string, metadata:T = [] as T): ClassDecorator{
        return (target) => {
...
export function createParamDecorator<T extends Record<string, any> = any>(
                ...
                return(
                        ...
                        descriptor: PropertyDescriptor
                                ...
                                const parameters = Reflect.getMetadata(DECORATORS.API_PARAMETERS,descriptor) || [];
                                Reflect.defineMetadata(
